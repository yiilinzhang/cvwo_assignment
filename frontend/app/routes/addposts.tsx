...
<div className="flex flex-col justify-start gap-2">
    ...
    <select className="w-40 h-10 border-2 rounded-2xl">
    ...
    <textarea className="border-2 rounded-2xl p-2 h-44"/></div>

    <button className="bg-[#9BE3FF] w-34 p-2 m-4 rounded-2xl hover:cursor-pointer"><text className="font-medium text-2xl">Post now!</text></button>
